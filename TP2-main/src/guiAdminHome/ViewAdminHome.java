...
public class ViewAdminHome {
	...
	public static void refreshInvitationCount() { // THIS IS ADDED BY DACIA TO UPDATE INVITATIONS COUNT
	    int count = theDatabase.getNumberOfInvitations();
	    label_NumberOfInvitations.setText("Number of outstanding invitations: " + count);
	}
	...
	*/
	...
	protected static String[] roles = {"<Select a role>", "Admin", "Student", "Staff"}; // ***MODIFIED***
	...
	/***
	 * MODIFIED: Alert added by Brenna for displaying the invitation list
	 */
	protected static Alert alertInvitationsList = new Alert(AlertType.INFORMATION);
	...
	*/
	...
	public static void displayAdminHome(Stage ps, User user) {
		...
		// ***MODIFIED***
	    label_UserDetails.setText("User: " + theUser.getUserName()); // tiny bug shows first admin as logged in
	    															 // this will refresh the user label
	...
	private ViewAdminHome() {
		...
		alertEmailSent.setContentText("This invitation code will expire in 1 minute."); // ***MODIFIED***
